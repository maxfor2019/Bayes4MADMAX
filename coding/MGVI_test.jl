...
@time first_iteration = mgvi_kl_optimize_step(rng, # why do I need to define an rng?! Seems like it should be a kwarg...
                                        model, data,
                                        starting_point;
...
coal_mine_disaster_data = read_coal_mining_data(joinpath("./data/tmp", "coal_mining_data.tsv"), 1);
...
plot()
plot_kernel_model(starting_point_a, 20)
